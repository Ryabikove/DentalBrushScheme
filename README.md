...
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://github.com/Ryabikove/DentalBrushScheme/blob/test/LICENSE)
...
## Documentation
available throw [link](Brush-schema%20(doc)/README.md)
...
When filing bugs:
- Describe it with clear and concise description of what the bug is.
- Write how to reproduce the behavior:
  - Go to '...' 
  - Click on '....' 
  - Scroll down to '....' 
  - See error 
- Describe expected behavior: a clear and concise description of what you expected to happen.
- If applicable, add screenshots to help explain your problem.
- Add additional context if it makes sense
When filing feature:
- If your feature request related to a problem, please describe. Ex. _I'm always frustrated when [...]_
- Describe what you want to happen clear and concise.
- If there is any alternative solutions or features you've considered, please describe.
- Add additional context if it makes sense